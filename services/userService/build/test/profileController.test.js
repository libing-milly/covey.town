...
describe("getAllProfiles", function () {
  it("get all profiles successfully", function (done) {
...
describe("findProfileForUser", function () {
  ...
  it("find profile for user successfully", function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
      var request;
      return __generator(this, function (_a) {
        request = supertest_1.default(profileAPI);
        request
          ...
          .end(function (err, res) {
            if (err) {
              ...
              expect(res.body.response.data.userId).toEqual(
                "6068f7f16ce91100046aed6f"
              );
              expect(res.body.response.data.username).toEqual("publish");
              expect(res.body.isOK).toEqual(true);
              expect(res.body.message).toEqual(
                "find profile for user successfully"
              );
              done();
            }
            30000;
  ...
  it("user id=${userId} was not found", function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
      var request;
      return __generator(this, function (_a) {
        request = supertest_1.default(profileAPI);
        request
          ...
          .end(function (err, res) {
            if (err) {
              ...
              expect(res.body.message).toEqual(
                "user id=1068f7f16ce91100046aed6f was not found"
              );
              expect(res.body.isOK).toEqual(false);
              done();
            }
...
describe("createProfileForUser", function () {
  it("user profile already exists", function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
  ...
  it("create profile for user successfully", function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
      var request, newProfile;
      return __generator(this, function (_a) {
        request = supertest_1.default(profileAPI);
  ...
  it("throw error no username", function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
      var request, newProfile;
      return __generator(this, function (_a) {
        request = supertest_1.default(profileAPI);
        ...
        request
          ...
          .end(function (err, res) {
            if (err) {
              ...
              expect(res.body.message).toEqual(
                "Profile validation failed: username: Path `username` is required."
              );
              expect(res.body.isOK).toEqual(false);
              done();
            }
...
describe("updateProfile", function () {
  ...
  it("profile id=${id} was not found", function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
      var request, newProfile;
      return __generator(this, function (_a) {
        request = supertest_1.default(profileAPI);
        ...
        request
          ...
          .end(function (err, res) {
            if (err) {
              ...
              expect(res.body.message).toEqual(
                "profile id=407235b971f16a0004c8a913 was not found"
              );
              expect(res.body.isOK).toEqual(false);
              done();
            }
  ...
  it("catch error and cannot update", function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
      var request, newProfile;
      return __generator(this, function (_a) {
        request = supertest_1.default(profileAPI);
