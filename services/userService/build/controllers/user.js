...
var validateToken = function (req, res, next) {
  logging_1.default.info(
    NAMESPACE,
    "token is validated, this user is verified."
  );
...
var register = function (req, res, next) {
  var _a = req.body,
    ...
    question1 = _a.question1,
    answer1 = _a.answer1,
    question2 = _a.question2,
    answer2 = _a.answer2,
    question3 = _a.question3,
    answer3 = _a.answer3;
...
var forgetPassword = function (req, res, next) {
  ...
  user_1.default
    ...
    .then(function (users) {
      ...
      if (
        answer1 !== users[0].answer1 ||
        answer2 !== users[0].answer2 ||
        answer3 !== users[0].answer3
      ) {
        return res.status(401).json({
